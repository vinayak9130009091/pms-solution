...
function ResetPassword() {
  ...
  const getuser = (id) => {
    ...
    const url = `${USER_LOGIN_API}/common/user/`;
    fetch(url + id, requestOptions)
      ...
      .then((result) => {
        ...
        const url = `${USER_LOGIN_API}/passwordupdate/`;
  ...
  const updatePassword = (id, token) => {
    ...
    const baseUrl = `${USER_LOGIN_API}/common/user/password/updateuserpassword/`;
  ...
  const UserValidToken = async () => {
    ...
    const url = `${USER_LOGIN_API}/common/resetpassword/verifytoken/`;
            ...
            <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
              ...
              <Box className="password-sub-container" sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexWrap: "wrap", maxWidth: "600px", width: "100%" }}>
                <Box className="pagetitle" sx={{ textAlign: "center", width: "100%" }}>
                  <Typography variant="h1" sx={{ fontSize: "38px", marginBottom: "5%" }}>
                    Set Password
                  </Typography>
                </Box>
