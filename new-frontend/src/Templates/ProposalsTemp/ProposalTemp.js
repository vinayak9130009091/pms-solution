...
import { Stepper, Step, StepLabel, Button, Typography, Box, Grid, TextField, FormControl, FormControlLabel, Switch, List, ListItem, ListItemText, Popover, Autocomplete } from "@mui/material";
...
const MyStepper = () => {
  ...
  const steps = ["General"].concat(stepsVisibility.Introduction ? ["Introduction"] : [], stepsVisibility.Terms ? ["Terms"] : [], stepsVisibility.ServicesInvoices ? ["Services & Invoices"] : []);
        ...
        return (
          <Box>
            ...
            <Box mt={2}>
              ...
              <TextField placeholder="Template name (not visible to clients)" size="small" margin="normal" fullWidth sx={{ backgroundColor: "#fff" }} />
            </Box>
