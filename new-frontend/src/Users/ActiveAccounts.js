...
import {
    ...
    FilledInput,
    OutlinedInput,
    Input, InputLabel, InputAdornment, FormHelperText, FormControl
...
const ActiveAccounts = () => {
    ...
    const fetchidwiseData = async () => {
        try {
            const url = `http://127.0.0.1:8880/admin/teammember/${_id}`;
            console.log(url)
    ...
    const handleSubmit = () => {
        ...
        fetch(`http://127.0.0.1:8880/admin/teammember/${_id}`, requestOptions)
    ...
    const getuser = async () => {
        try {
            ...
            const response = await fetch(`http://127.0.0.1:8880/common/user/email/getuserbyemail/${email}`, requestOptions);
            if (!response.ok) {
    ...
    const updatePassword = (_id, token) => {
        ...
        const urlupdateuserpassword = 'http://127.0.0.1:8880/common/user/password/updateuserpassword/';
